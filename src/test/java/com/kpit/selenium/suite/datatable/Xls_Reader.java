package com.kpit.selenium.suite.datatable;
...
public class Xls_Reader {
        ...
        private Map<String, Map<String, Integer>> sheetWiseColumnNamePositionMap = new HashMap<String, Map<String,Integer>>();
        ...
        public String getCellData(String sheetName,String colName,int rowNum){
                ...
                sheet = workbook.getSheetAt(index);
                Map<String, Integer> nameToPosMap = sheetWiseColumnNamePositionMap.get(sheetName);
                if (nameToPosMap == null) {
                    nameToPosMap = new HashMap<String, Integer>();
                    sheetWiseColumnNamePositionMap.put(sheetName, nameToPosMap);
                    row=sheet.getRow(0);
                    for(int i=0;i<row.getLastCellNum();i++){
                        nameToPosMap.put(row.getCell(i).getStringCellValue().trim(), i);
                    }
                }
                col_Num = nameToPosMap.get(colName);
                if(col_Num==-1 || col_Num == null)
                        return "";
